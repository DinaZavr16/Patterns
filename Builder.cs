...
namespace Builder
{
    class Program
    {
        ...
        //Concrete Builder MargaritaPizzaBuilder
        class MargaritaPizzaBuilder : PizzaBuilder
        {
            public override void BuildDough() { pizza.SetDough("pan baked+cross"); }
            public override void BuildSauce() { pizza.SetSauce("hot+mild"); }
            public override void BuildTopping() { pizza.SetTopping("pepparoni+salami+ham+pineapple"); }
        }
        class Waiter
        {
